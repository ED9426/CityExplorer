Backend README for Project Two (CS400 @ UW Madison)
========================================================

Name of Backend: Austin Cohen 
@wisc.edu Email of Backend: aacohen3@wisc.edu
Group: GE
Team: red
...
BackendInterface.java: is an interface that is implemented by the Backend has methods: addCity(), getOrderedCities(), getSize(), & getCity().
